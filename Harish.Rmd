...
The median is only different from the mean ever so slightly; this means the outliers are not skewing our data too much, and we can proceed with more data analysis.
